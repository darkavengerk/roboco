...
const PM_COLUMNS = [
  ...
  { id: "incoming", status: TaskStatus.PENDING, title: "집필 대기", color: "bg-gray-100 dark:bg-gray-800" },
  ...
  { id: "blocked", status: TaskStatus.BLOCKED, title: "보류", color: "bg-red-100 dark:bg-red-900" },
  { id: "paused", status: TaskStatus.PAUSED, title: "중단", color: "bg-amber-50 dark:bg-amber-950" },
  { id: "qa", status: TaskStatus.AWAITING_QA, title: "편집 중", color: "bg-yellow-50 dark:bg-yellow-950" },
  { id: "needs-revision", status: TaskStatus.NEEDS_REVISION, title: "수정 요청", color: "bg-rose-50 dark:bg-rose-950" },
  { id: "docs", status: TaskStatus.AWAITING_DOCUMENTATION, title: "설정 반영", color: "bg-purple-50 dark:bg-purple-950" },
  { id: "pr-review", status: TaskStatus.AWAITING_PR_REVIEW, title: "원고 심사", color: "bg-teal-50 dark:bg-teal-950" },
  { id: "pm-review", status: TaskStatus.AWAITING_PM_REVIEW, title: "총괄 검토", color: "bg-orange-50 dark:bg-orange-950" },
  { id: "ceo-approval", status: TaskStatus.AWAITING_CEO_APPROVAL, title: "작가 승인", color: "bg-indigo-50 dark:bg-indigo-950" },
  { id: "done", status: TaskStatus.COMPLETED, title: "확정", color: "bg-green-50 dark:bg-green-950" },
  { id: "cancelled", status: TaskStatus.CANCELLED, title: "폐기", color: "bg-zinc-100 dark:bg-zinc-900" },
];
